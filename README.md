...
3. [Files needed by the user](#files-needed-by-the-user)
4. [Expected input data](#expected-input-data)
   - [Minimum requirement](#minimum-requirement)
   - [Optional context column](#optional-context-column)
   - [One row = one unit of annotation](#one-row--one-unit-of-annotation)
5. [Output produced by the app](#output-produced-by-the-app)
6. [Categories used in the app](#categories-used-in-the-app)
7. [How to start the app](#how-to-start-the-app)
   - [Option 1: Run from RStudio](#option-1-run-from-rstudio)
   - [Option 2: Run from the R console](#option-2-run-from-the-r-console)
8. [First-time package installation](#first-time-package-installation)
9. [Main structure of the interface](#main-structure-of-the-interface)
   - [Left sidebar](#left-sidebar)
   - [Main panel](#main-panel)
10. [Step-by-step workflow](#step-by-step-workflow)
    - [Load the data](#1-load-the-data)
    - [Read progress information](#2-read-progress-information)
    - [Read the context and text](#3-read-the-context-and-text)
    - [Decide whether the item is a valid sentence](#4-decide-whether-the-item-is-a-valid-sentence)
    - [Code the primary topic](#5-code-the-primary-topic)
    - [Code uncertainty](#6-code-uncertainty)
    - [Code stance](#7-code-stance)
    - [Code whether the item is policy-related](#8-code-whether-the-item-is-policy-related)
    - [Add a second topic if needed](#9-add-a-second-topic-if-needed)
    - [Record the annotation](#10-record-the-annotation)
    - [Save a draft instead of a final annotation](#11-save-a-draft-instead-of-a-final-annotation)
    - [Clear the current row’s coding](#12-clear-the-current-rows-coding)
11. [Navigation](#navigation)
12. [Saving your work](#saving-your-work)
    - [Manual save](#1-manual-save-to-a-chosen-directory)
    - [Temporary autosave](#2-temporary-autosave)
    - [Download annotated CSV](#3-download-annotated-csv)
13. [How file paths work](#how-file-paths-work)
14. [Timestamps recorded by the app](#timestamps-recorded-by-the-app)
15. [Meaning of the main annotation fields](#meaning-of-the-main-annotation-fields)
16. [Recommended workflow for users](#recommended-workflow-for-users)
17. [Common issues and solutions](#common-issues-and-solutions)
18. [Good practice recommendations](#good-practice-recommendations)
19. [Suggested folder structure](#suggested-folder-structure)
20. [Minimal example of how to launch the app](#minimal-example-of-how-to-launch-the-app)
21. [Summary](#summary)
